...
const CartPage = () => {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const response = await fetch("http://localhost:8081/api/payment/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      ...
      const options = {
        key: "rzp_test_0baawWoSt6hujs", // Replace with your Razorpay Key ID
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await fetch("http://localhost:8081/api/payment/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              credentials: "include",
              body: JSON.stringify({
